...
public class SuiteConfiguration {
  ...
  public SuiteConfiguration(String fromResource) throws IOException {
    ...
    properties.load(BaseXML.SuiteConfiguration.class.getResourceAsStream(fromResource));
  }
  ...
  public Capabilities getCapabilities() throws IOException {
    ...
    capsProps.load(BaseXML.SuiteConfiguration.class.getResourceAsStream(capabilitiesFile));
